...
void main() {
  group('isPrime', () {
    ...
    test('true.F36526C57E4A7A60F897ED82F895E7E8CE298D376F1DBD1AC645FAE98DEA10FF', () {
      for (int i = 0; i < 100; i++) {
        expect(
            BigInt.parse(
    ...
    test('true.D68B9700EDA654646406EA065DEDE8FDDE403978F8D6F4C1F03E88506BBC6C5D', () {
      for (int i = 0; i < 100; i++) {
        expect(
            BigInt.parse(
    ...
    test('false.CBFB45E6B09F1AF40DF60DDC865B6F98A1FD724678B583BFB5AE8539627BFFDCD930D7C3F996F75E15172A017F143101ECD28FC629B800E24F0A83665D77C0A3', () {
      for (int i = 0; i < 100; i++) {
        expect(
            BigInt.parse(
